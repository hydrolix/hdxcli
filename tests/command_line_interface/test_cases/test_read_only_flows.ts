...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project project settings"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project project settings description 'Modified-with-hdxcli-tool'"]
#teardown = ["python3 -m hdx_cli.main --project test_ci_project project settings description 'Created-with-hdxcli-tool'"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project project activity"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project table create test_table"]
#teardown = ["python3 -m hdx_cli.main --project test_ci_project table delete --disable-confirmation-prompt test_table"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table table show"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table table activity"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table transform list"]
...
##commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --transform test_ci_transform transform settings type csv"]
##teardown = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --transform test_ci_transform transform settings type json"]
...
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --transform test_ci_transform transform show"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kafka_source sources kafka settings"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kafka_source sources kafka settings name new_kafka_name"]
#teardown = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source new_kafka_name sources kafka settings name test_ci_kafka_source"]
#expected_output = 'Updated test_ci_kafka_source name'
#
#[[test]]
#name = "Kafka source bootstrap_servers can be shown"
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kafka_source sources kafka settings settings.bootstrap_servers"]
#expected_output = "settings.bootstrap_servers: ['104.198.40.96:9092']"
#
#[[test]]
#name = "Kafka sources can be shown"
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --source test_ci_kafka_source sources kafka show"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kinesis_source sources kinesis settings"]
#expected_output_expr = 'not result.startswith("Error:") and "name" in result and "type" in result and "value" in result'
#
## failing because of the pool is crashing
##[[test]]
##name = "Kinesis source name can be modified"
##commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kinesis_source sources kinesis settings name new_kinesis_name"]
##teardown = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source new_kinesis_name sources kinesis settings name test_ci_kinesis_source"]
##expected_output = 'Updated test_ci_kinesis_source name'
#
#[[test]]
#name = "Kinesis source type can be shown"
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_kinesis_source sources kinesis settings type"]
#expected_output = 'type: pull'
#
#[[test]]
#name = "Kinesis sources can be shown"
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --source test_ci_kinesis_source sources kinesis show"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_siem_source sources siem settings"]
...
##commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_siem_source sources siem settings name new_kinesis_name"]
##teardown = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source new_kinesis_name sources siem settings name test_ci_siem_source"]
##expected_output = 'Updated test_ci_siem_source name'
#
#[[test]]
#name = "SIEM source type can be shown"
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table --source test_ci_siem_source sources siem settings type"]
#expected_output = 'type: pull'
#
#[[test]]
#name = "SIEM sources can be shown"
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --source test_ci_siem_source sources siem show"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --storage test_ci_storage storage settings"]
...
#commands_under_test = ["python3 -m hdx_cli.main --storage test_ci_storage storage settings settings.cloud"]
#expected_output = 'settings.cloud: gcp'
#
#[[test]]
#name = "Storage cloud can be modified"
#commands_under_test = ["python3 -m hdx_cli.main --storage test_ci_storage storage settings settings.cloud aws"]
#teardown = ["python3 -m hdx_cli.main --storage test_ci_storage storage settings settings.cloud gcp"]
#expected_output = 'Updated test_ci_storage settings.cloud'
#
#[[test]]
#name = "Storages can be shown"
#commands_under_test = ["python3 -m hdx_cli.main --storage test_ci_storage storage show"]
...
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --job test_ci_batch_job job batch settings"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#setup = ["python3 -m hdx_cli.main set test_ci_project test_ci_table"]
#commands_under_test = ["python3 -m hdx_cli.main --job test_ci_batch_job job batch show"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project function list"]
#expected_output_re = '.*?test_ci_function.*'
#
#[[test]]
#name = "Functions can be created using in-line sql"
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project function create -s '(x,k,b)->k*x+b' test_function"]
...
#setup = ["python3 -m hdx_cli.main set test_ci_project",
#		     "python3 -m hdx_cli.main --project test_ci_project function create -s '(x,k,b)->k*x+b' test_function"]
...
#setup = ["python3 -m hdx_cli.main set test_ci_project"]
#commands_under_test = ["python3 -m hdx_cli.main --function test_ci_function function settings"]
#teardown = ["python3 -m hdx_cli.main unset"]
...
#commands_under_test = ["python3 -m hdx_cli.main --project test_ci_project --table test_ci_table dictionary files list"]
