...
def _serialize_to_config_file(profile: ProfileUserContext, config_file_path: Path):
    all_profiles = None
...
def set_default_resources(ctx: click.Context, projectname: str, tablename: str):
    ...
    if tablename and (not profile.projectname and not projectname):
        raise LogicException(
            "In order to set the table name you must also have the project name "
