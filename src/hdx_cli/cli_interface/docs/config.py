...
DOC_STRUCTURE: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "frontmatter": {
            ...
            "excerpt": "Commands for security management. Administer user and service accounts, assign roles and permissions, and configure credentials for external systems.",
            "category": "65774de90f4b3f001039021c",
            "hidden": False
        }
    },
